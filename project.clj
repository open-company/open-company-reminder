(defproject open-company-reminder "0.1.0-SNAPSHOT"
  :description "OpenCompany Reminder Service"
  :url "https://github.com/open-company/open-company-reminder"
  :license {
  ...
  :dependencies [
    ...
    [open-company/lib "0.16.34-alpha1"]
  ...
  :aliases{
    ...
    "create-migration" ["run" "-m" "oc.reminder.db.migrations" "create"] ; create a data migration
    "migrate-db" ["run" "-m" "oc.reminder.db.migrations" "migrate"] ; run pending data migrations
    "start" ["do" "run" "-m" "oc.reminder.app"] ; start a development server
